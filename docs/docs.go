...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/workflow-deployments/batch-deploy": {
            "post": {
        ...
        "/api/workflow-deployments/deploy": {
            "post": {
        ...
        "/api/workflow-deployments/{id}/rollback": {
            "post": {
        ...
        "models.LineStructure": {
            ...
            "properties": {
                "condition": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.ConditionStructure"
                        }
                    ]
                },
                "id": {
        ...
        "models.NodeStructure": {
            ...
            "properties": {
                ...
                "inputs": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.ParameterStructure"
                    }
                },
                "key_name": {
                    "description": "节点标识",
                ...
                "python_script": {
                    ...
                    "type": "string",
                    "example": "def execute(context): pass"
                },
                "type": {
                    "description": "节点类型",
                    "type": "string",
