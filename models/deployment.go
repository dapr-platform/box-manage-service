...
type InferenceTask struct {
	...
	TriggerWorkflowID      *uint         `json:"triggerWorkflowId,omitempty"`      // 绑定 workflow 的 ID
	TriggerWorkflowVersion int           `json:"triggerWorkflowVersion,omitempty"` // 绑定 workflow 的版本号
