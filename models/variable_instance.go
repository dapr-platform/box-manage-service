...
type VariableInstance struct {
	...
	KeyName            string         `gorm:"type:varchar(100);not null" json:"key_name" example:"image_url"`
	...
	Scope              string         `gorm:"type:varchar(50);not null;default:'global'" json:"scope" example:"global"`
